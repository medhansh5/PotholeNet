@echo off
REM PotholeNet v3.0 - Windows Build Script
REM Builds the native C++ library for Windows testing

echo Building PotholeNet v3.0 Native Bridge for Windows...
echo.
...
cmake .. -A x64 -DCMAKE_BUILD_TYPE=Release -DBUILD_TESTS=OFF
...
copy Release\potholenet_core.dll ..\
